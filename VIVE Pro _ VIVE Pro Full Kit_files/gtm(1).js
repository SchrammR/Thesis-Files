...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__c",
      "vtp_value":"UA-78366313-6"
    },{
      "function":"__c",
      "vtp_value":"UA-66085733-1"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":1,
  ...
  "tags":[{
      ...
      "vtp_uniqueTriggerId":"2682531_19",
      "tag_id":7
    },{
      "function":"__lcl",
      ...
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"2682531_27",
      "tag_id":8
    },{
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Eif(\"undefined\"==typeof YT||\"undefined\"==typeof YT.Player){var j=document.createElement(\"script\"),f=document.getElementsByTagName(\"script\")[0];j.src=\"\/\/www.youtube.com\/iframe_api\";j.async=!0;f.parentNode.insertBefore(j,f)}for(var e=document.getElementsByTagName(\"iframe\"),x=e.length;x--;)\/youtube.com\\\/embed\/.test(e[x].src)\u0026\u0026-1===e[x].src.indexOf(\"enablejsapi\\x3d\")\u0026\u0026(e[x].src+=(-1===e[x].src.indexOf(\"?\")?\"?\":\"\\x26\")+\"enablejsapi\\x3d1\");var gtmYTListeners=[];e=document.getElementsByTagName(\"iframe\");\nfor(x=e.length;x--;)\/youtube.com\\\/embed\/.test(e[x].src)\u0026\u0026(gtmYTListeners.push(new YT.Player(e[x],{events:{onStateChange:onPlayerStateChange,onError:onPlayerError}})),YT.gtmLastAction=\"p\",console.log(\"Listeners.push\".x));console.log(\"ready\");\nfunction onPlayerStateChange(a){a.data==YT.PlayerState.PLAYING\u0026\u0026setTimeout(onPlayerPercent,1E3,a.target);var b=a.target.getVideoData(),d=document.title;if(a.data==YT.PlayerState.PLAYING\u0026\u0026\"p\"==YT.gtmLastAction){var c=\"Video Played - \"+b.title;viveDataLayer.push({event:\"youtube-event\",eventCategory:\"Youtube Videos\",eventAction:d,eventLabel:c});YT.gtmLastAction=\"\"}a.data==YT.PlayerState.PAUSED\u0026\u0026(c=\"Video Paused - \"+b.title,viveDataLayer.push({event:\"youtube-event\",eventCategory:\"Youtube Videos\",eventAction:d,\neventLabel:c}),YT.gtmLastAction=\"p\");console.log(\"change\")}function onPlayerError(a){viveDataLayer.push({event:\"youtube-event\",eventCategory:\"Youtube Videos Error\",eventAction:\"youtube error\",eventLabel:\"youtube:\"+a.target.src+\"-\"+a.data});console.log(\"error\")}\nfunction onPlayerPercent(a){if(a.getPlayerState()==YT.PlayerState.PLAYING){var b=1.5\u003E=a.getDuration()-a.getCurrentTime()?1:(Math.floor(a.getCurrentTime()\/a.getDuration()*4)\/4).toFixed(2);if(!a.lastP||b\u003Ea.lastP){var d=a.getVideoData(),c=document.title;a.lastP=b;b=100*b+\"% Video played - \"+d.title;viveDataLayer.push({event:\"youtube-event\",eventCategory:\"Youtube Videos\",eventAction:c,eventLabel:b})}1!=a.lastP\u0026\u0026setTimeout(onPlayerPercent,1E3,a)}};\u003C\/script\u003E",
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Eif(\"undefined\"==typeof YT||\"undefined\"==typeof YT.Player){var j=document.createElement(\"script\"),f=document.getElementsByTagName(\"script\")[0];j.src=\"\/\/www.youtube.com\/iframe_api\";j.async=!0;f.parentNode.insertBefore(j,f)};\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":5
